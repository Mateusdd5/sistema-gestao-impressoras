...
<div class="resumo-custos">
    ...
    <% } else { %>
        <h5>💰 Custo Mensal - <%= secretariaFiltro %></h5>
        <%
        BigDecimal custoSecretaria = custosPorSecretaria.getOrDefault(secretariaFiltro, BigDecimal.ZERO);
        %>
        <div class="custo-secretaria">
            <span><strong><%= secretariaFiltro %>:</strong></span>
            <span class="custo-destaque"><%= currencyFormat.format(custoSecretaria) %></span>
        </div>
    <% } %>
</div>
<% } %>

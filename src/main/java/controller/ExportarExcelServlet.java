...
public class ExportarExcelServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conexao = Conexao.getConnection()) {
            ...
            // Usuário de secretaria tem escopo fixo; usuário TI usa o parâmetro da URL
            ...
            // Buscar impressoras conforme o filtro
            ...
            Map<String, BigDecimal> custosPorSecretaria =
                    impressoraDAO.calcularCustoMensalPorSecretaria();
            ...
            // Aba de resumo — só gerada quando não há filtro de secretaria específica
            if (!filtrandoPorSecretaria) {
                criarAbaResumo(workbook, listaImpressoras, custosPorSecretaria,
                        headerStyle, dataStyle, currencyStyle, totalStyle);
            }
            ...
            for (Map.Entry<String, List<Impressora>> entry : impressorasPorSecretaria.entrySet()) {
                ...
                List<Impressora> imps = entry.getValue();
                criarAbaSecretaria(workbook, sec, imps,
                        headerStyle, dataStyle, currencyStyle, dateStyle, totalStyle);
            }

            // Nome do arquivo reflete o filtro aplicado
            String nomeArquivo = filtrandoPorSecretaria
                    ? "impressoras_" + secretaria + "_"
                      + LocalDate.now().format(DateTimeFormatter.ofPattern("yyyyMMdd")) + ".xlsx"
                    : "impressoras_" + LocalDate.now().format(DateTimeFormatter.ofPattern("yyyyMMdd")) + ".xlsx";
    ...
    private void criarAbaResumo(Workbook workbook, List<Impressora> todasImpressoras,
        ...
        for (Map.Entry<String, List<Impressora>> entry : porSecretaria.entrySet()) {
            ...
            // Custo mensal
            BigDecimal custoSec = custosPorSecretaria.getOrDefault(sec, BigDecimal.ZERO);
